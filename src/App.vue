      ...
      <div class="d-flex align-items-center flex-column mb-3">
        <ul>
          ...
          <li v-if="film.original_language === 'it'">
            lingua del film: it <img src="/public/flags/it4x3.svg" alt="" />
          </li>
          <li v-else-if="film.original_language === 'en'">
            lingua del film: en <img src="/public/flags/us4x3.svg" alt="" />
          </li>
      ...
      <div class="d-flex align-items-center flex-column mb-3">
        <ul>
          ...
          <li v-if="serietv.original_language === 'it'">
            lingua della serie tv: it <img src="/public/flags/it4x3.svg" alt="" />
          </li>
          <li v-else-if="serietv.original_language === 'en'">
            lingua della serie tv: en <img src="/public/flags/us4x3.svg" alt="" />
          </li>
          <li v-else>lingua della serie tv: {{ serietv.original_language }}</li>

          <!-- Voto -->
          <li>numero di voti: {{ serietv.vote_count }}</li>
        </ul>
      </div>
    </div>
  </div>
